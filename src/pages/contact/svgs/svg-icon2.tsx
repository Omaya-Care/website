export default function Icon2({ cid }: { cid?: string }) {
  return (
    <svg className="w-4 h-4 block overflow-hidden align-middle text-color-001" data-component="icon" aria-hidden="true" fill="none" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg" data-cid={cid}>
      <path fillRule="evenodd" clipRule="evenodd" d="M12 2.25C9.23858 2.25 7 4.48858 7 7.25V9.07501C5.28832 9.42247 4 10.9358 4 12.75V18.25C4 20.3211 5.67893 22 7.75 22H16.25C18.3211 22 20 20.3211 20 18.25V12.75C20 10.9358 18.7117 9.42247 17 9.07501V7.25C17 4.48858 14.7614 2.25 12 2.25ZM15.5 9V7.25C15.5 5.317 13.933 3.75 12 3.75C10.067 3.75 8.5 5.317 8.5 7.25V9H15.5ZM12 13.25C12.4142 13.25 12.75 13.5858 12.75 14V17C12.75 17.4142 12.4142 17.75 12 17.75C11.5858 17.75 11.25 17.4142 11.25 17V14C11.25 13.5858 11.5858 13.25 12 13.25Z" fill="currentColor" />
    </svg>
  );
}

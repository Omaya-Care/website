...
export default function FeatureGridItem({ d, cids }: { d: FeatureGridItemData; cids: string[] }) {
  return (
    <div data-id={cids[0]} className="flex flex-col justify-start items-stretch">
      <div data-id={cids[1]} className="block relative">
        <FeatureGridItemSlot1 d={d} />
        <FeatureGridItemSlot2 d={d} />
      </div>
      <div data-id={cids[2]} className="h-[7.25rem] flex py-[1.375rem] pr-[1.375rem] flex-col justify-center items-start gap-[7.3px] max-md:h-[7.875rem] max-lg:py-6 max-md:items-center max-lg:gap-2 max-md:text-center max-md:pr-0 md:max-lg:h-[8.225rem] md:max-lg:pr-6 2xl:h-[8.4rem] 2xl:py-6 2xl:pr-6 2xl:gap-2">
        <div data-id={cids[3]} className="block text-xl leading-[1.5rem] tracking-[-0.3px] max-md:text-lg max-md:leading-[1.5625rem] max-md:tracking-[-0.2px] md:max-lg:text-[1.375rem] md:max-lg:leading-[1.9375rem] md:max-lg:tracking-[-0.4px] 2xl:text-2xl 2xl:leading-[2.125rem] 2xl:tracking-[-0.4px]">
          {d.eyebrow}
        </div>
        <div data-id={cids[4]} className="block text-muted-foreground">
          {d.title}
        </div>
      </div>
    </div>
    ...
    case "one-simple-blood-draw-to-measure-100-bioma":
      return (
        <>
          ...
          <div className="w-[27.5px] h-[27.5px] flex absolute top-[7.3px] left-[7.3px] rounded-md justify-center items-center text-background text-[0.8125rem] leading-[1.125rem] bg-color-008 [backdrop-filter:blur(16px)] max-lg:w-7.5 max-lg:h-7.5 max-lg:top-2 max-lg:left-2 max-lg:text-sm max-lg:leading-[1.25rem] 2xl:w-7.5 2xl:h-7.5 2xl:top-2 2xl:left-2 2xl:text-sm 2xl:leading-[1.25rem]" data-id="n89">
            {d.stat}
            <br className="block" data-id="n90" />
          </div>
...
function FeatureGridItemSlot2({ d }: { d: FeatureGridItemData }) {
  switch (d.variant) {
    ...
    case "get-a-complete-picture-of-your-health-data":
      return (
        <div className="w-[27.5px] h-[27.5px] flex absolute top-[7.3px] left-[7.3px] rounded-md justify-center items-center text-background text-[0.8125rem] leading-[1.125rem] bg-color-008 [backdrop-filter:blur(16px)] max-lg:w-7.5 max-lg:h-7.5 max-lg:top-2 max-lg:left-2 max-lg:text-sm max-lg:leading-[1.25rem] 2xl:w-7.5 2xl:h-7.5 2xl:top-2 2xl:left-2 2xl:text-sm 2xl:leading-[1.25rem]" data-id="n98">
          {d.stat}
          <br className="block" data-id="n99" />
        </div>
      );
    case "ai-builds-evidence-backed-protocols-inform":
      return (
        <div className="w-[27.5px] h-[27.5px] flex absolute top-[7.3px] left-[7.3px] rounded-md justify-center items-center text-background text-[0.8125rem] leading-[1.125rem] bg-color-008 [backdrop-filter:blur(16px)] max-lg:w-7.5 max-lg:h-7.5 max-lg:top-2 max-lg:left-2 max-lg:text-sm max-lg:leading-[1.25rem] 2xl:w-7.5 2xl:h-7.5 2xl:top-2 2xl:left-2 2xl:text-sm 2xl:leading-[1.25rem]" data-id="n106">
          {d.stat}
        </div>
      );
    case "take-action-access-everything-you-need-the":
      return (
        <div className="w-[27.5px] h-[27.5px] flex absolute top-[7.3px] left-[7.3px] rounded-md justify-center items-center text-background text-[0.8125rem] leading-[1.125rem] bg-color-008 [backdrop-filter:blur(16px)] max-lg:w-7.5 max-lg:h-7.5 max-lg:top-2 max-lg:left-2 max-lg:text-sm max-lg:leading-[1.25rem] 2xl:w-7.5 2xl:h-7.5 2xl:top-2 2xl:left-2 2xl:text-sm 2xl:leading-[1.25rem]" data-id="n113">
          {d.stat}
          <br className="block" data-id="n114" />
        </div>
      );
    default:
      return null;

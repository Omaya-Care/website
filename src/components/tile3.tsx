...
export default function Tile3({ d, cids }: { d: Tile3Data; cids: string[] }) {
  return (
    <div data-id={cids[0]} className="h-[24.7px] flex justify-start items-start gap-[0.6875rem] text-muted-foreground max-md:h-6 max-lg:gap-3 md:max-lg:h-[1.6875rem] 2xl:h-[1.6875rem] 2xl:gap-3">

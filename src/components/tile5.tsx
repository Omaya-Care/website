...
export default function Tile5({ d, cids, styles }: { d: Tile5Data; cids: string[]; styles: Tile5Styles }) {
  return (
    <div data-cid={cids[0]} className={cn("flex items-center gap-3 pointer-events-none", styles.className)}>
      <div data-cid={cids[1]} className={cn("w-[0.3125rem] h-[0.3125rem] flex justify-center items-center text-color-001 text-[0.3125rem] leading-[0.4375rem] pointer-events-none", styles.className2)}>
        •
      </div>

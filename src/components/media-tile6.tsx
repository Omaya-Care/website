...
export default function MediaTile6({ d, cids, styles }: { d: MediaTile6Data; cids: string[]; styles: MediaTile6Styles }) {
  return (
    <li data-id={cids[0]} className={cn("list-item py-1 pl-2 pointer-events-none", styles.className)}>
      <button data-id={cids[1]} className={cn("flex opacity-50 items-center text-background text-left cursor-pointer pointer-events-none", styles.className2)} type="button">
        ...
        <span data-id={cids[5]} className="block min-w-0 flex-1 pointer-events-none">
          {d.label}
        </span>
      </button>
    </li>
